...
const { getProducts, getProductById, createProduct, updateProduct, deleteProductById, getProductInventoryStatus, getProductByBarcode } = require('../../controllers/products.controllers');
